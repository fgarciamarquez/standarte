...
- Opción recomendada: definir en el servidor la variable de entorno
  STANDARTE_SMTP_PASSWORD con la contraseña de javier@standarte.es.
...
- DMARC: puede empezar en modo observación con un TXT en _dmarc:
  v=DMARC1; p=none; rua=mailto:javier@standarte.es; adkim=s; aspf=s
...
--------------------------------
- Enviar desde javier@standarte.es.
