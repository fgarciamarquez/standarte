// Textos de la página de PRECIOS en los 11 idiomas.
//
// Viven en $lib/server/ y NO en el componente a propósito: dentro de Precios.svelte los
// once idiomas viajaban al navegador en cada visita aunque solo se muestre uno, y como la
// ruta comodín importa de forma estática los seis componentes de página (Site, Feria,
// Noticias, Precios, Actividad, Proyecto), ese peso lo cargaba TAMBIÉN quien entraba a una
// ficha de feria o a la portada. El load del servidor elige el idioma y solo ese texto se
// embebe en el HTML prerenderizado.
//
// No se puede resolver con import() dinámico: en el prerenderizado el bloque quedaría sin
// resolver y el HTML saldría vacío de contenido, que es justo lo que no queremos para SEO.
