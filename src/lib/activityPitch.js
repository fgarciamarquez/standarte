...
export const activityPitchCopy = {
  "es": {
    "heading": "¿Eres una empresa que busca una expansión en España y Portugal?",
  ...
  "pt": {
    "heading": "És uma empresa que procura uma expansão em Espanha e Portugal?",
  ...
  "en": {
    "heading": "Are you a company looking to expand across Spain and Portugal?",
  ...
  "de": {
    "heading": "Sind Sie ein Unternehmen, das nach Spanien und Portugal expandieren will?",
  ...
  "fr": {
    "heading": "Êtes-vous une entreprise qui cherche à se développer en Espagne et au Portugal ?",
  ...
  "it": {
    "heading": "Sei un'azienda che cerca un'espansione in Spagna e Portogallo?",
  ...
  "nl": {
    "heading": "Bent u een bedrijf dat wil uitbreiden in Spanje en Portugal?",
  ...
  "zh": {
    "heading": "您是希望在西班牙和葡萄牙拓展业务的企业吗？",
    "text": "Standarte 以无可挑剔且始终如一的品质，为您感兴趣的所有展会和大会搭建展台。专为需要从展会投资中获取战略回报的企业而设计。",
    "cta": "按活动查看展会"
  },
  "hi": {
    "heading": "क्या आप स्पेन और पुर्तगाल में विस्तार चाहने वाली कंपनी हैं?",
