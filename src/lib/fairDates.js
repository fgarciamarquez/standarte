...
export const fairDates = {
  ...
  'termatalia-ourense': { start: '2026-09-24', end: '2026-09-25', cadence: 'annual', source: 'https://www.termatalia.com/en/' },
  ...
  'feria-internacional-ganadera-zafra': { start: '2026-10-01', end: '2026-10-06', cadence: 'annual', source: 'https://fig.zafra.es/' },
  'san-diego-comic-con-malaga': { start: '2026-10-01', end: '2026-10-04', cadence: 'annual', source: 'https://sandiegocomicconmalaga.com/' },
  'conxemar-vigo': { start: '2026-10-06', end: '2026-10-08', cadence: 'annual', source: 'https://www.conxemar.com/es/feria/' },
  ...
  'fecons-torre-pacheco': { start: '2026-10-22', end: '2026-10-24', cadence: 'biennial', source: 'https://ifepa.es/fecons/' },
  ...
  'expometal-batalha': { start: '2026-11-11', end: '2026-11-13', cadence: 'biennial', source: 'https://exposalao.pt/pt/feira/expometal' },
  ...
  'biocultura-a-coruna': { start: '2027-03-05', end: '2027-03-07', cadence: 'annual', source: 'https://www.biocultura.org/acoruna/informacion-expositores' },
  ...
  'infarma': { start: '2027-03-16', end: '2027-03-18', cadence: 'annual', source: 'https://www.infarma.es/' },
  ...
  'forum-gastronomico-a-coruna': { start: '2027-04-04', end: '2027-04-06', cadence: 'biennial', source: 'https://www.vinetur.com/20260609102344/galicia-forum-gastronomico-abre-la-venta-de-espacios-para-su-edicion-de-2027.html' },
  ...
  'stone-iberica-batalha': { start: '2027-05-06', end: '2027-05-08', cadence: 'biennial', source: 'https://exposalao.pt/feiras' },
  ...
  'agroglobal-santarem': { start: '2027-09-07', end: '2027-09-09', cadence: 'biennial', source: 'https://www.agroportal.pt/agroglobal-2027-a-maior-feira-agricola-profissional-da-iberia/' },
  ...
  'navalia-vigo': { start: '2028-05-23', end: '2028-05-25', cadence: 'biennial', source: 'https://www.navalia.es/es/' }
};
