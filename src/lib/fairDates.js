...
export const fairDates = {
  ...
  // SCM Conference: Quinta do Frade, Sobral de Monte Agraço (~40 km de Lisboa). Última edición confirmada; 2027 por confirmar.
  'stand-scm-conference': { start: '2026-05-05', end: '2026-05-06', cadence: 'annual', source: 'https://www.supplychainmagazine.pt/scmconference/' },
  ...
  'stands-smagua-zaragoza': { start: '2027-02-16', end: '2027-02-18', cadence: 'biennial', source: 'https://www.feriazaragoza.es/en/smagua' },
  'stands-expofimer-zaragoza': { start: '2027-03-10', end: '2027-03-11', cadence: 'annual', source: 'https://www.feriazaragoza.es/expofimer' },
  'stands-spaper-zaragoza': { start: '2027-02-16', end: '2027-02-18', cadence: 'biennial', source: 'https://www.feriazaragoza.es/spaper' },
  'stand-essencia-do-vinho-porto': { start: '2027-02-18', end: '2027-02-21', cadence: 'annual', source: 'https://www.essenciadovinho.com/' },
  'stands-modtissimo-oporto': { start: '2026-09-17', end: '2026-09-18', cadence: 'unknown', source: 'https://exponor.pt/calendario-de-eventos/' },
  'stands-qualifica-oporto': { start: '2027-03-03', end: '2027-03-06', cadence: 'annual', source: 'https://exponor.pt/qualifica/' },
  'stands-gift-paper-oporto': { start: '2026-02-26', end: '2026-02-28', cadence: 'annual', source: 'https://exponor.pt/calendario/gift-paper/' },
  'stands-tecnipao-oporto': { start: '2026-03-06', end: '2026-03-09', cadence: 'unknown', source: 'https://exponor.pt/calendario/tecnipao/' },
  ...
  'stands-aratur-zaragoza': { start: '2026-05-15', end: '2026-05-17', cadence: 'annual', source: 'https://www.feriazaragoza.es/en/prensa/aratur-celebra-su-20a-edicion-nuevas-incorporaciones-nacionales-internacionales' },
  ...
  'stands-figan-feria-zaragoza': { start: '2027-03-16', end: '2027-03-19', cadence: 'biennial', source: 'https://www.feriazaragoza.es/figan' },
