...
import { HIDE_IMAGE_SECTIONS, RETIRED_SECTIONS } from './imagePolicy.js';
...
export const routes = {
  es: {
    ...
    team: 'equipo',
    contact: 'contacto',
    madrid: 'diseno-construccion-montaje-stands-madrid',
    barcelona: 'diseno-construccion-montaje-stands-barcelona',
    bilbao: 'diseno-construccion-montaje-stands-bilbao',
    lisboa: 'diseno-construccion-montaje-stands-lisboa',
    batalha: 'diseno-construccion-montaje-stands-batalha',
    silleda: 'diseno-construccion-montaje-stands-silleda',
    santander: 'diseno-construccion-montaje-stands-santander',
    ...
    pamplona: 'diseno-construccion-montaje-stands-pamplona',
    vitoria: 'diseno-construccion-montaje-stands-vitoria',
    aranda: 'diseno-construccion-montaje-stands-aranda-de-duero',
    regua: 'diseno-construccion-montaje-stands-peso-da-regua',
    ibiza: 'diseno-construccion-montaje-stands-ibiza',
    menorca: 'diseno-construccion-montaje-stands-menorca',
    ceuta: 'diseno-construccion-montaje-stands-ceuta',
    melilla: 'diseno-construccion-montaje-stands-melilla',
    tanger: 'diseno-construccion-montaje-stands-tanger',
    casablanca: 'diseno-construccion-montaje-stands-casablanca',
    rabat: 'diseno-construccion-montaje-stands-rabat',
    andorra: 'diseno-construccion-montaje-stands-andorra',
    teruel: 'diseno-construccion-montaje-stands-teruel',
    marsella: 'diseno-construccion-montaje-stands-marsella',
    cannes: 'diseno-construccion-montaje-stands-cannes',
    avignon: 'diseno-construccion-montaje-stands-avignon',
    toulouse: 'diseno-construccion-montaje-stands-toulouse',
    burdeos: 'diseno-construccion-montaje-stands-burdeos',
    lyon: 'diseno-construccion-montaje-stands-lyon',
    grenoble: 'diseno-construccion-montaje-stands-grenoble',
    clermont_ferrand: 'diseno-construccion-montaje-stands-clermont-ferrand',
    montpellier: 'diseno-construccion-montaje-stands-montpellier',
    niza: 'diseno-construccion-montaje-stands-niza',
    perpignan: 'diseno-construccion-montaje-stands-perpignan',
    gijon: 'diseno-construccion-montaje-stands-gijon',
    lleida: 'diseno-construccion-montaje-stands-lleida',
    girona: 'diseno-construccion-montaje-stands-girona',
    ourense: 'diseno-construccion-montaje-stands-ourense',
    vigo: 'diseno-construccion-montaje-stands-vigo',
    santiago: 'diseno-construccion-montaje-stands-santiago-de-compostela',
    coruna: 'diseno-construccion-montaje-stands-a-coruna',
    valladolid: 'diseno-construccion-montaje-stands-valladolid',
    salamanca: 'diseno-construccion-montaje-stands-salamanca',
    mallorca: 'diseno-construccion-montaje-stands-mallorca',
    valencia: 'diseno-construccion-montaje-stands-valencia',
    alicante: 'diseno-construccion-montaje-stands-alicante',
    murcia: 'diseno-construccion-montaje-stands-murcia',
    oporto: 'diseno-construccion-montaje-stands-oporto',
    portugal_sur: 'diseno-construccion-montaje-stands-portugal-sur',
    islas_canarias: 'diseno-construccion-montaje-stands-islas-canarias',
    islas_de_madeira: 'diseno-construccion-montaje-stands-islas-madeira',
    malaga: 'diseno-construccion-montaje-stands-malaga',
    badajoz: 'diseno-construccion-montaje-stands-badajoz',
    sevilla: 'diseno-construccion-montaje-stands-sevilla',
    ...
    constructor_stand_fitur: 'constructor_stand_fitur',
    constructor_stand_fruit_attraction: 'constructor_stand_fruit_attraction',
    constructor_stand_sicur: 'constructor_stand_sicur',
    constructor_stand_salon_look: 'constructor_stand_salon_look',
    constructor_stand_veteco: 'constructor_stand_veteco',
    constructor_stand_hygienalia: 'constructor_stand_hygienalia',
    constructor_stand_advanced_manufacturing: 'constructor_stand_advanced_manufacturing',
    constructor_stand_hip: 'constructor_stand_hip',
    constructor_stand_meat_attraction: 'constructor_stand_meat_attraction',
    constructor_stand_arcomadrid: 'constructor_stand_arcomadrid',
    constructor_stand_salon_gourmets: 'constructor_stand_salon_gourmets',
    constructor_stand_madrid_fusion: 'constructor_stand_madrid_fusion',
    constructor_stand_piscimad: 'constructor_stand_piscimad',
    constructor_stand_iberpet: 'constructor_stand_iberpet',
    constructor_stand_empack: 'constructor_stand_empack',
    constructor_stand_smart_doors: 'constructor_stand_smart_doors',
    constructor_stand_expomedes: 'constructor_stand_expomedes',
    constructor_stand_madrid_tech_show: 'constructor_stand_madrid_tech_show',
    constructor_stand_the_district: 'constructor_stand_the_district',
    constructor_stand_intergift: 'constructor_stand_intergift',
    constructor_stand_momad: 'constructor_stand_momad',
    constructor_stand_madridjoya: 'constructor_stand_madridjoya',
    constructor_stand_bisutex: 'constructor_stand_bisutex',
    constructor_stand_rebuild: 'constructor_stand_rebuild',
    constructor_stand_expofranquicia: 'constructor_stand_expofranquicia',
    constructor_stand_expodental: 'constructor_stand_expodental',
    constructor_stand_expooptica: 'constructor_stand_expooptica',
    constructor_stand_optom: 'constructor_stand_optom',
    constructor_stand_farmaforum: 'constructor_stand_farmaforum',
    constructor_stand_genera: 'constructor_stand_genera',
    constructor_stand_trafic: 'constructor_stand_trafic',
    constructor_stand_fiaa: 'constructor_stand_fiaa',
    constructor_stand_global_mobility_call: 'constructor_stand_global_mobility_call',
    constructor_stand_motortec: 'constructor_stand_motortec',
    constructor_stand_matelec: 'constructor_stand_matelec',
    constructor_stand_sima: 'constructor_stand_sima',
    constructor_stand_intersicop: 'constructor_stand_intersicop',
    ...
    constructor_stand_valencia: 'constructor_stand_valencia',
    constructor_stand_valladolid: 'constructor_stand_valladolid',
    constructor_stand_alicante: 'constructor_stand_alicante',
    constructor_stand_elche: 'constructor_stand_elche',
    constructor_stand_murcia: 'constructor_stand_murcia',
    constructor_stand_salamanca: 'constructor_stand_salamanca',
    constructor_stand_coruna: 'constructor_stand_coruna',
    constructor_stand_santiago: 'constructor_stand_santiago',
    constructor_stand_vigo: 'constructor_stand_vigo',
    constructor_stand_ourense: 'constructor_stand_ourense',
    constructor_stand_silleda: 'constructor_stand_silleda',
    constructor_stand_gijon: 'constructor_stand_gijon',
    constructor_stand_santander: 'constructor_stand_santander',
    constructor_stand_irun: 'constructor_stand_irun',
    constructor_stand_vitoria: 'constructor_stand_vitoria',
    constructor_stand_pamplona: 'constructor_stand_pamplona',
    constructor_stand_logrono: 'constructor_stand_logrono',
    constructor_stand_lleida: 'constructor_stand_lleida',
    constructor_stand_girona: 'constructor_stand_girona',
    constructor_stand_mallorca: 'constructor_stand_mallorca',
    constructor_stand_ibiza: 'constructor_stand_ibiza',
    constructor_stand_menorca: 'constructor_stand_menorca',
    constructor_stand_islas_canarias: 'constructor_stand_islas_canarias',
    constructor_stand_ceuta: 'constructor_stand_ceuta',
    constructor_stand_melilla: 'constructor_stand_melilla',
    constructor_stand_tanger: 'constructor_stand_tanger',
    constructor_stand_casablanca: 'constructor_stand_casablanca',
    constructor_stand_rabat: 'constructor_stand_rabat',
    constructor_stand_andorra: 'constructor_stand_andorra',
    constructor_stand_teruel: 'constructor_stand_teruel',
    ...
    constructor_stand_huelva: 'constructor_stand_huelva',
    constructor_stand_cordoba: 'constructor_stand_cordoba',
    constructor_stand_granada: 'constructor_stand_granada',
    constructor_stand_cadiz: 'constructor_stand_cadiz',
    constructor_stand_marsella: 'constructor_stand_marsella',
    constructor_stand_cannes: 'constructor_stand_cannes',
    constructor_stand_avignon: 'constructor_stand_avignon',
    constructor_stand_toulouse: 'constructor_stand_toulouse',
    constructor_stand_burdeos: 'constructor_stand_burdeos',
    constructor_stand_lyon: 'constructor_stand_lyon',
    constructor_stand_grenoble: 'constructor_stand_grenoble',
    constructor_stand_clermont_ferrand: 'constructor_stand_clermont_ferrand',
    constructor_stand_niza: 'constructor_stand_niza',
    constructor_stand_montpellier: 'constructor_stand_montpellier',
    constructor_stand_perpignan: 'constructor_stand_perpignan',
    constructor_stand_batalha: 'constructor_stand_batalha',
    constructor_stand_santarem: 'constructor_stand_santarem',
    constructor_stand_regua: 'constructor_stand_regua',
    constructor_stand_portugal_sur: 'constructor_stand_portugal_sur',
    ...
    constructor_stand_smopyc: 'constructor_stand_smopyc',
    constructor_stand_smagua: 'constructor_stand_smagua',
    constructor_stand_aratur: 'constructor_stand_aratur',
    constructor_stand_expofimer: 'constructor_stand_expofimer',
    constructor_stand_spaper: 'constructor_stand_spaper',
    constructor_stand_fima: 'constructor_stand_fima',
    constructor_stand_enomaq: 'constructor_stand_enomaq',
    constructor_stand_oleomaq: 'constructor_stand_oleomaq',
    constructor_stand_tecnovid: 'constructor_stand_tecnovid',
    constructor_stand_salon_vinos_aragon: 'constructor_stand_salon_vinos_aragon',
    constructor_stand_enoforum: 'constructor_stand_enoforum',
    constructor_stand_agroexpo: 'ferias/constructor-stand-agroexpo',
    constructor_stand_biemh: 'ferias/constructor-stand-biemh',
    montaje_zafra: 'montaje-stands-zafra',
    montaje_don_benito: 'montaje-stands-don-benito',
    montaje_badajoz: 'montaje-stands-badajoz',
    almeria: 'diseno-construccion-montaje-stands-almeria',
    jaen: 'diseno-construccion-montaje-stands-jaen',
    huelva: 'diseno-construccion-montaje-stands-huelva',
    cordoba: 'diseno-construccion-montaje-stands-cordoba',
    granada: 'diseno-construccion-montaje-stands-granada',
    cadiz: 'diseno-construccion-montaje-stands-cadiz',
    santarem: 'diseno-construccion-montaje-stands-santarem',
    trujillo: 'diseno-construccion-montaje-stands-trujillo',
    elche: 'diseno-construccion-montaje-stands-elche',
    noticias: 'blog',
    ferias: 'ferias'
  },
  en: {
    ...
    // Páginas paralelas de constructor (defensa ante denuncias). Ver builderPages.js.
    constructor_stand_zaragoza: 'stand_builder_zaragoza',
    constructor_stand_madrid: 'stand_builder_madrid',
    constructor_stand_fitur: 'stand_builder_fitur',
    constructor_stand_fruit_attraction: 'stand_builder_fruit_attraction',
    constructor_stand_sicur: 'stand_builder_sicur',
    constructor_stand_salon_look: 'stand_builder_salon_look',
    constructor_stand_veteco: 'stand_builder_veteco',
    constructor_stand_hygienalia: 'stand_builder_hygienalia',
    constructor_stand_advanced_manufacturing: 'stand_builder_advanced_manufacturing',
    constructor_stand_hip: 'stand_builder_hip',
    constructor_stand_meat_attraction: 'stand_builder_meat_attraction',
    constructor_stand_arcomadrid: 'stand_builder_arcomadrid',
    constructor_stand_salon_gourmets: 'stand_builder_salon_gourmets',
    constructor_stand_madrid_fusion: 'stand_builder_madrid_fusion',
    constructor_stand_piscimad: 'stand_builder_piscimad',
    constructor_stand_iberpet: 'stand_builder_iberpet',
    constructor_stand_empack: 'stand_builder_empack',
    constructor_stand_smart_doors: 'stand_builder_smart_doors',
    constructor_stand_expomedes: 'stand_builder_expomedes',
    constructor_stand_madrid_tech_show: 'stand_builder_madrid_tech_show',
    constructor_stand_the_district: 'stand_builder_the_district',
    constructor_stand_intergift: 'stand_builder_intergift',
    constructor_stand_momad: 'stand_builder_momad',
    constructor_stand_madridjoya: 'stand_builder_madridjoya',
    constructor_stand_bisutex: 'stand_builder_bisutex',
    constructor_stand_rebuild: 'stand_builder_rebuild',
    constructor_stand_expofranquicia: 'stand_builder_expofranquicia',
    constructor_stand_expodental: 'stand_builder_expodental',
    constructor_stand_expooptica: 'stand_builder_expooptica',
    constructor_stand_optom: 'stand_builder_optom',
    constructor_stand_farmaforum: 'stand_builder_farmaforum',
    constructor_stand_genera: 'stand_builder_genera',
    constructor_stand_trafic: 'stand_builder_trafic',
    constructor_stand_fiaa: 'stand_builder_fiaa',
    constructor_stand_global_mobility_call: 'stand_builder_global_mobility_call',
    constructor_stand_motortec: 'stand_builder_motortec',
    constructor_stand_matelec: 'stand_builder_matelec',
    constructor_stand_sima: 'stand_builder_sima',
    constructor_stand_intersicop: 'stand_builder_intersicop',
    constructor_stand_barcelona: 'stand_builder_barcelona',
    constructor_stand_oporto: 'stand_builder_porto',
    constructor_stand_lisboa: 'stand_builder_lisbon',
    constructor_stand_bilbao: 'stand_builder_bilbao',
    ...
    constructor_stand_valencia: 'stand_builder_valencia',
    constructor_stand_valladolid: 'stand_builder_valladolid',
    constructor_stand_alicante: 'stand_builder_alicante',
    constructor_stand_elche: 'stand_builder_elche',
    constructor_stand_murcia: 'stand_builder_murcia',
    constructor_stand_salamanca: 'stand_builder_salamanca',
    constructor_stand_coruna: 'stand_builder_a_coruna',
    constructor_stand_santiago: 'stand_builder_santiago_de_compostela',
    constructor_stand_vigo: 'stand_builder_vigo',
    constructor_stand_ourense: 'stand_builder_ourense',
    constructor_stand_silleda: 'stand_builder_silleda',
    constructor_stand_gijon: 'stand_builder_gijon',
    constructor_stand_santander: 'stand_builder_santander',
    constructor_stand_irun: 'stand_builder_irun',
    constructor_stand_vitoria: 'stand_builder_vitoria',
    constructor_stand_pamplona: 'stand_builder_pamplona',
    constructor_stand_logrono: 'stand_builder_logrono',
    constructor_stand_lleida: 'stand_builder_lleida',
    constructor_stand_girona: 'stand_builder_girona',
    constructor_stand_mallorca: 'stand_builder_mallorca',
    constructor_stand_ibiza: 'stand_builder_ibiza',
    constructor_stand_menorca: 'stand_builder_menorca',
    constructor_stand_islas_canarias: 'stand_builder_canary_islands',
    constructor_stand_ceuta: 'stand_builder_ceuta',
    constructor_stand_melilla: 'stand_builder_melilla',
    constructor_stand_tanger: 'stand_builder_tangier',
    constructor_stand_casablanca: 'stand_builder_casablanca',
    constructor_stand_rabat: 'stand_builder_rabat',
    constructor_stand_andorra: 'stand_builder_andorra',
    constructor_stand_teruel: 'stand_builder_teruel',
    ...
    constructor_stand_huelva: 'stand_builder_huelva',
    constructor_stand_cordoba: 'stand_builder_cordoba',
    constructor_stand_granada: 'stand_builder_granada',
    constructor_stand_cadiz: 'stand_builder_cadiz',
    constructor_stand_marsella: 'stand_builder_marseille',
    constructor_stand_cannes: 'stand_builder_cannes',
    constructor_stand_avignon: 'stand_builder_avignon',
    constructor_stand_toulouse: 'stand_builder_toulouse',
    constructor_stand_burdeos: 'stand_builder_bordeaux',
    constructor_stand_lyon: 'stand_builder_lyon',
    constructor_stand_grenoble: 'stand_builder_grenoble',
    constructor_stand_clermont_ferrand: 'stand_builder_clermont_ferrand',
    constructor_stand_niza: 'stand_builder_nice',
    constructor_stand_montpellier: 'stand_builder_montpellier',
    constructor_stand_perpignan: 'stand_builder_perpignan',
    constructor_stand_batalha: 'stand_builder_batalha',
    constructor_stand_santarem: 'stand_builder_santarem',
    ...
    constructor_stand_smopyc: 'stand_builder_smopyc',
    constructor_stand_smagua: 'stand_builder_smagua',
    constructor_stand_aratur: 'stand_builder_aratur',
    constructor_stand_expofimer: 'stand_builder_expofimer',
    constructor_stand_spaper: 'stand_builder_spaper',
    constructor_stand_fima: 'stand_builder_fima',
    constructor_stand_enomaq: 'stand_builder_enomaq',
    constructor_stand_oleomaq: 'stand_builder_oleomaq',
    constructor_stand_tecnovid: 'stand_builder_tecnovid',
    constructor_stand_salon_vinos_aragon: 'stand_builder_salon_vinos_aragon',
    constructor_stand_enoforum: 'stand_builder_enoforum',
  ...
  pt: {
    ...
    // Páginas paralelas de constructor (defensa ante denuncias). Ver builderPages.js.
    // En portugués existen solo las dos plazas portuguesas: son donde el comprador
    // busca en su propio idioma («construtor de stands no Porto / em Lisboa»).
    constructor_stand_oporto: 'construtor_stands_porto',
    constructor_stand_lisboa: 'construtor_stands_lisboa',
    constructor_stand_batalha: 'construtor_stands_batalha',
    constructor_stand_santarem: 'construtor_stands_santarem',
    constructor_stand_regua: 'construtor_stands_peso_da_regua',
    constructor_stand_portugal_sur: 'construtor_stands_sul_portugal',
    constructor_stand_islas_de_madeira: 'construtor_stands_ilhas_madeira',
...
export const SQ_REMOVED_SECTIONS = new Set([
  'noticias', 'precios', 'galeria', 'proyecto_auditado', 'custom', 'team',
  ...
  'constructor_stand_fitur', 'constructor_stand_fruit_attraction', 'constructor_stand_sicur', 'constructor_stand_salon_look', 'constructor_stand_veteco', 'constructor_stand_hygienalia', 'constructor_stand_advanced_manufacturing', 'constructor_stand_hip', 'constructor_stand_meat_attraction', 'constructor_stand_arcomadrid', 'constructor_stand_salon_gourmets', 'constructor_stand_madrid_fusion', 'constructor_stand_piscimad', 'constructor_stand_iberpet', 'constructor_stand_empack', 'constructor_stand_smart_doors', 'constructor_stand_expomedes', 'constructor_stand_madrid_tech_show', 'constructor_stand_the_district', 'constructor_stand_intergift', 'constructor_stand_momad', 'constructor_stand_madridjoya', 'constructor_stand_bisutex', 'constructor_stand_rebuild', 'constructor_stand_expofranquicia', 'constructor_stand_expodental', 'constructor_stand_expooptica', 'constructor_stand_optom', 'constructor_stand_farmaforum', 'constructor_stand_genera', 'constructor_stand_trafic', 'constructor_stand_fiaa', 'constructor_stand_global_mobility_call', 'constructor_stand_motortec', 'constructor_stand_matelec', 'constructor_stand_sima', 'constructor_stand_intersicop',
  'constructor_stand_smopyc', 'constructor_stand_smagua', 'constructor_stand_aratur', 'constructor_stand_expofimer', 'constructor_stand_spaper', 'constructor_stand_fima', 'constructor_stand_enomaq', 'constructor_stand_oleomaq', 'constructor_stand_tecnovid', 'constructor_stand_salon_vinos_aragon', 'constructor_stand_enoforum',
...
export const prerenderEntries = languages.flatMap((lang) => {
  const normalRoutes = Object.keys(routes[lang])
    ...
    // Galería «Proyectos a medida» y «Equipo» se retiran mientras la web va sin imágenes.
    .filter((section) => !(HIDE_IMAGE_SECTIONS && RETIRED_SECTIONS.has(section)))
