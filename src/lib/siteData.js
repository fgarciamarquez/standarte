...
export const copy = {
  es: {
    ...
    seoTitle: 'Standarte | Construcción de stands en Madrid, Barcelona, Bilbao, Málaga y Lisboa - Presupuesto en 24h',
    seoDescription: 'Standarte diseña, fabrica y monta stands de forma profesional y personalizada para ferias en Madrid, Barcelona, Bilbao, Málaga, Badajoz, Ciudad Real, Lisboa y otros destinos. ¡Presupuesto en 24h!',
  ...
  en: {
    ...
    contactTitle: 'Proposal in 24 hours',
  ...
  de: {
    ...
    contactTitle: 'Angebot in 24 Stunden',
  ...
  hi: {
    ...
    contactTitle: '24 घंटे में प्रस्ताव',
  ...
  pt: {
    ...
    contactTitle: 'Proposta em 24 horas',
  ...
  fr: {
    ...
    contactTitle: 'Proposition en 24 heures',
  ...
  it: {
    ...
    contactTitle: 'Proposta in 24 ore',
