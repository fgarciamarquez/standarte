...
export const cityData = {
  ...
  marsella: {
    ...
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Marsella —gran plaza del arco mediterráneo francés, sede de la Foire Internationale de Marseille en el Parc Chanot— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Marseille —a major hub of the French Mediterranean arc, home to the Foire Internationale de Marseille at Parc Chanot— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Marseille — einem wichtigen Zentrum des französischen Mittelmeerbogens, Austragungsort der Foire Internationale de Marseille im Parc Chanot — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      pt: { intro: 'Com 20 anos de experiência a construir arquitetura efémera a partir da nossa oficina própria, a Standarte atravessa os Pirenéus e projeta e monta stands em Marselha — grande praça do arco mediterrânico francês, sede da Foire Internationale de Marseille no Parc Chanot — controlando cada fase: design 3D, fabrico, transporte, montagem e validações no recinto.', detail: 'Oferecemos a agências e expositores a tranquilidade de uma montagem sem surpresas e uma excecional atenção aos detalhes, também do outro lado da fronteira.' },
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Marseille — grande place de l\'arc méditerranéen français, siège de la Foire Internationale de Marseille au Parc Chanot — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Marsiglia — grande piazza dell\'arco mediterraneo francese, sede della Foire Internationale de Marseille al Parc Chanot — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Marseille — een belangrijk knooppunt van de Franse mediterrane boog, thuisbasis van de Foire Internationale de Marseille in het Parc Chanot — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在马赛为展会设计并搭建展台——这是法国地中海弧线上的重要城市，Parc Chanot 举办马赛国际博览会——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      hi: { intro: 'अपनी ही कार्यशाला से अस्थायी वास्तुकला बनाने के 20 वर्षों के अनुभव के साथ, Standarte पिरेनीज़ पार करके मार्सिले में स्टैंड डिज़ाइन और स्थापित करता है — यह फ़्रांसीसी भूमध्यसागरीय चाप का एक प्रमुख केंद्र है, जहाँ Parc Chanot में Foire Internationale de Marseille आयोजित होती है — हर चरण को नियंत्रित करते हुए: 3D डिज़ाइन, निर्माण, परिवहन, स्थापना और स्थल पर सत्यापन।', detail: 'हम एजेंसियों और प्रदर्शकों को सीमा के उस पार भी बिना किसी आश्चर्य के असेंबली और विवरण पर असाधारण ध्यान की निश्चिंतता प्रदान करते हैं।' },
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 마르세유에서 전시회 부스를 디자인하고 시공합니다. 이곳은 프랑스 지중해 연안의 주요 거점으로, Parc Chanot에서 Foire Internationale de Marseille가 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、マルセイユで展示会ブースの設計・施工を行います。ここはフランス地中海沿岸の主要都市で、Parc Chanotでマルセイユ国際見本市が開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  cannes: {
    city: { es: 'Cannes', en: 'Cannes', de: 'Cannes', zh: '戛纳', hi: 'कान', pt: 'Cannes', fr: 'Cannes', it: 'Cannes', ko: '칸', ja: 'カンヌ', nl: 'Cannes' },
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Cannes —capital del lujo en la Costa Azul, sede del Cannes Yachting Festival, MAPIC, MIPIM y TFWA World Exhibition en el Palais des Festivals— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Cannes —the French Riviera\'s capital of luxury, home to the Cannes Yachting Festival, MAPIC, MIPIM and TFWA World Exhibition at the Palais des Festivals— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Cannes — der Luxushauptstadt der Côte d\'Azur, Austragungsort des Cannes Yachting Festival, der MAPIC, der MIPIM und der TFWA World Exhibition im Palais des Festivals — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Cannes — capitale du luxe sur la Côte d\'Azur, siège du Cannes Yachting Festival, du MAPIC, du MIPIM et du TFWA World Exhibition au Palais des Festivals — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Cannes — capitale del lusso sulla Costa Azzurra, sede del Cannes Yachting Festival, di MAPIC, di MIPIM e del TFWA World Exhibition al Palais des Festivals — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Cannes — de luxehoofdstad van de Côte d\'Azur, thuisbasis van het Cannes Yachting Festival, MAPIC, MIPIM en de TFWA World Exhibition in het Palais des Festivals — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在戛纳为展会设计并搭建展台——这是蔚蓝海岸的奢华之都，举办戛纳游艇展、MAPIC、MIPIM 和 TFWA World Exhibition（均在电影节宫）——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 칸에서 전시회 부스를 디자인하고 시공합니다. 이곳은 코트다쥐르의 럭셔리 중심지로, Palais des Festivals에서 칸 요트 페스티벌, MAPIC, MIPIM, TFWA World Exhibition이 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、カンヌで展示会ブースの設計・施工を行います。ここはコート・ダジュールを代表するラグジュアリー都市で、Palais des Festivalsでカンヌ・ヨットフェスティバル、MAPIC、MIPIM、TFWA World Exhibitionが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  avignon: {
    city: { es: 'Aviñón', en: 'Avignon', de: 'Avignon', zh: '阿维尼翁', hi: 'अविञ्यों', pt: 'Avinhão', fr: 'Avignon', it: 'Avignone', ko: '아비뇽', ja: 'アヴィニョン', nl: 'Avignon' },
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Aviñón —capital de Provenza y del Ródano, sede de MED\'Agri en el Parc des Expositions— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Avignon —capital of Provence and the Rhône, home to MED\'Agri at the Parc des Expositions— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Avignon — der Hauptstadt der Provence und der Rhône, Austragungsort der MED\'Agri im Parc des Expositions — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Avignon — capitale de la Provence et du Rhône, siège de MED\'Agri au Parc des Expositions — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand ad Avignone — capitale della Provenza e del Rodano, sede di MED\'Agri al Parc des Expositions — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Avignon — hoofdstad van de Provence en de Rhône, thuisbasis van MED\'Agri in het Parc des Expositions — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在阿维尼翁为展会设计并搭建展台——这是普罗旺斯与罗讷河的中心城市，Parc des Expositions 举办 MED\'Agri 地中海农业展——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 아비뇽에서 전시회 부스를 디자인하고 시공합니다. 이곳은 프로방스와 론 지방의 중심지로, Parc des Expositions에서 MED\'Agri가 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、アヴィニョンで展示会ブースの設計・施工を行います。ここはプロヴァンスとローヌ地方の中心都市で、Parc des ExpositionsでMED\'Agriが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  toulouse: {
    city: { es: 'Toulouse', en: 'Toulouse', de: 'Toulouse', zh: '图卢兹', hi: 'तुलूज़', pt: 'Toulouse', fr: 'Toulouse', it: 'Tolosa', ko: '툴루즈', ja: 'トゥールーズ', nl: 'Toulouse' },
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Toulouse —capital de Occitania y de la aeronáutica europea, sede de la Foire Internationale de Toulouse en el MEETT— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Toulouse —capital of Occitania and of European aeronautics, home to the Foire Internationale de Toulouse at the MEETT— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Toulouse — der Hauptstadt Okzitaniens und der europäischen Luftfahrt, Austragungsort der Foire Internationale de Toulouse im MEETT — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Toulouse — capitale de l\'Occitanie et de l\'aéronautique européenne, siège de la Foire Internationale de Toulouse au MEETT — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Tolosa — capitale dell\'Occitania e dell\'aeronautica europea, sede della Foire Internationale de Toulouse al MEETT — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Toulouse — hoofdstad van Occitanië en van de Europese luchtvaart, thuisbasis van de Foire Internationale de Toulouse in de MEETT — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在图卢兹为展会设计并搭建展台——这是奥克西塔尼大区与欧洲航空业的中心，MEETT 举办图卢兹国际博览会——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 툴루즈에서 전시회 부스를 디자인하고 시공합니다. 이곳은 옥시타니와 유럽 항공 산업의 중심지로, MEETT에서 Foire Internationale de Toulouse가 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、トゥールーズで展示会ブースの設計・施工を行います。ここはオクシタニー地域圏と欧州航空産業の中心都市で、MEETTでトゥールーズ国際見本市が開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  burdeos: {
    city: { es: 'Burdeos', en: 'Bordeaux', de: 'Bordeaux', zh: '波尔多', hi: 'बोर्डो', pt: 'Bordéus', fr: 'Bordeaux', it: 'Bordeaux', ko: '보르도', ja: 'ボルドー', nl: 'Bordeaux' },
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Burdeos —capital de Nueva Aquitania y capital mundial del vino, sede de la Foire Internationale de Bordeaux en el Parc des Expositions de Bordeaux-Lac— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Bordeaux —capital of Nouvelle-Aquitaine and the world capital of wine, home to the Foire Internationale de Bordeaux at the Parc des Expositions de Bordeaux-Lac— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Bordeaux — der Hauptstadt Nouvelle-Aquitaines und der Welthauptstadt des Weins, Austragungsort der Foire Internationale de Bordeaux im Parc des Expositions de Bordeaux-Lac — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Bordeaux — capitale de la Nouvelle-Aquitaine et capitale mondiale du vin, siège de la Foire Internationale de Bordeaux au Parc des Expositions de Bordeaux-Lac — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Bordeaux — capitale della Nuova Aquitania e capitale mondiale del vino, sede della Foire Internationale de Bordeaux al Parc des Expositions de Bordeaux-Lac — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Bordeaux — hoofdstad van Nouvelle-Aquitaine en wereldhoofdstad van de wijn, thuisbasis van de Foire Internationale de Bordeaux in het Parc des Expositions de Bordeaux-Lac — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在波尔多为展会设计并搭建展台——这是新阿基坦大区的首府，也是世界葡萄酒之都，Bordeaux-Lac 会展中心举办波尔多国际博览会——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 보르도에서 전시회 부스를 디자인하고 시공합니다. 이곳은 누벨아키텐의 중심 도시이자 세계 와인의 수도로, Parc des Expositions de Bordeaux-Lac에서 Foire Internationale de Bordeaux가 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、ボルドーで展示会ブースの設計・施工を行います。ここはヌーヴェル＝アキテーヌ地域圏の中心都市であり、世界のワインの都で、Parc des Expositions de Bordeaux-Lacでボルドー国際見本市が開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  lyon: {
    city: { es: 'Lyon', en: 'Lyon', de: 'Lyon', zh: '里昂', hi: 'ल्यों', pt: 'Lyon', fr: 'Lyon', it: 'Lione', ko: '리옹', ja: 'リヨン', nl: 'Lyon' },
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Lyon —segunda economía de Francia, sede del gran recinto Eurexpo Lyon y capital mundial de la gastronomía, con citas como SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack y BEPOSITIVE— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Lyon —France\'s second-largest economy, home to the major Eurexpo Lyon venue and the world capital of gastronomy, with events such as SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack and BEPOSITIVE— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Lyon — Frankreichs zweitgrößter Wirtschaftsregion, Standort des großen Messegeländes Eurexpo Lyon und Welthauptstadt der Gastronomie, mit Veranstaltungen wie SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack und BEPOSITIVE — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Lyon — deuxième économie de France, siège du grand parc des expositions Eurexpo Lyon et capitale mondiale de la gastronomie, avec des rendez-vous comme SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack et BEPOSITIVE — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Lione — seconda economia della Francia, sede del grande polo fieristico Eurexpo Lyon e capitale mondiale della gastronomia, con appuntamenti come SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack e BEPOSITIVE — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Lyon — de op één na grootste economie van Frankrijk, thuisbasis van het grote beursterrein Eurexpo Lyon en wereldhoofdstad van de gastronomie, met evenementen zoals SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack en BEPOSITIVE — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在里昂为展会设计并搭建展台——这是法国第二大经济体，Eurexpo Lyon 大型会展中心所在地，也是世界美食之都，举办 SIRHA、Global Industrie、Pollutec、Piscine Global Europe、Préventica Lyon、Prod&Pack 和 BEPOSITIVE 等展会——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 리옹에서 전시회 부스를 디자인하고 시공합니다. 이곳은 프랑스 제2의 경제 도시이자 대형 전시장 Eurexpo Lyon이 위치한 곳이며 세계 미식의 수도로, SIRHA, Global Industrie, Pollutec, Piscine Global Europe, Préventica Lyon, Prod&Pack, BEPOSITIVE 등이 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、リヨンで展示会ブースの設計・施工を行います。ここはフランス第2の経済都市であり、大規模な見本市会場Eurexpo Lyonを擁し、美食の世界首都でもあり、SIRHA、Global Industrie、Pollutec、Piscine Global Europe、Préventica Lyon、Prod&Pack、BEPOSITIVEなどが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  grenoble: {
    ...
    content: {
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Grenoble — capitale des Alpes françaises, siège du parc des expositions Alpexpo, avec des rendez-vous comme Mountain Planet (équipement et tourisme de montagne) et SEPEM Industries Sud-Est (services et maintenance industrielle) — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Grenoble — capitale delle Alpi francesi, sede del polo fieristico Alpexpo, con appuntamenti come Mountain Planet (attrezzature e turismo di montagna) e SEPEM Industries Sud-Est (servizi e manutenzione industriale) — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Grenoble — hoofdstad van de Franse Alpen, thuisbasis van het beursterrein Alpexpo, met evenementen zoals Mountain Planet (bergtoerisme en -uitrusting) en SEPEM Industries Sud-Est (industriële diensten en onderhoud) — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在格勒诺布尔为展会设计并搭建展台——这是法国阿尔卑斯山区的首府，Alpexpo 展览中心所在地，举办 Mountain Planet（山地设备与旅游）和 SEPEM Industries Sud-Est（工业服务与维护）等展会——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 그르노블에서 전시회 부스를 디자인하고 시공합니다. 이곳은 프랑스 알프스의 중심 도시이자 Alpexpo 전시장이 위치한 곳으로, Mountain Planet(산악 장비 및 관광)과 SEPEM Industries Sud-Est(산업 서비스 및 유지보수) 등이 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、グルノーブルで展示会ブースの設計・施工を行います。ここはフランス・アルプスの中心都市であり、Alpexpo見本市会場を擁し、Mountain Planet（山岳設備・観光）やSEPEM Industries Sud-Est（産業サービス・メンテナンス）などが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  clermont_ferrand: {
    ...
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Clermont-Ferrand —capital de Auvernia, sede de la Grande Halle d\'Auvergne, con el Sommet de l\'Élevage, el mayor salón ganadero de Europa— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Clermont-Ferrand —capital of Auvergne, home to the Grande Halle d\'Auvergne, with the Sommet de l\'Élevage, Europe\'s largest livestock trade show— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Clermont-Ferrand — der Hauptstadt der Auvergne, Standort der Grande Halle d\'Auvergne, mit dem Sommet de l\'Élevage, Europas größter Viehzuchtmesse — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Clermont-Ferrand — capitale dell\'Alvernia, sede della Grande Halle d\'Auvergne, con il Sommet de l\'Élevage, il maggiore salone zootecnico d\'Europa — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Clermont-Ferrand — hoofdstad van Auvergne, thuisbasis van de Grande Halle d\'Auvergne, met de Sommet de l\'Élevage, de grootste veeteeltbeurs van Europa — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在克莱蒙费朗为展会设计并搭建展台——这是奥弗涅大区的首府，Grande Halle d\'Auvergne 展览中心所在地，举办欧洲最大的畜牧展 Sommet de l\'Élevage——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 클레르몽페랑에서 전시회 부스를 디자인하고 시공합니다. 이곳은 오베르뉴의 중심 도시이자 Grande Halle d\'Auvergne 전시장이 위치한 곳으로, 유럽 최대의 축산 박람회 Sommet de l\'Élevage가 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、クレルモン＝フェランで展示会ブースの設計・施工を行います。ここはオーヴェルニュ地域圏の中心都市であり、Grande Halle d\'Auvergne見本市会場を擁し、欧州最大の畜産見本市Sommet de l\'Élevageが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  niza: {
    city: { es: 'Niza', en: 'Nice', de: 'Nizza', zh: '尼斯', hi: 'नीस', pt: 'Nice', fr: 'Nice', it: 'Nizza', ko: '니스', ja: 'ニース', nl: 'Nice' },
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Niza —capital de la Costa Azul, ciudad UNESCO y segunda puerta aérea de Francia, con citas como AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales y SOLUCOP repartidas entre el Palais des Expositions, el puerto y el Allianz Riviera— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Nice —capital of the French Riviera, UNESCO city and France\'s second air gateway, with events such as AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales and SOLUCOP held across the Palais des Expositions, the port and the Allianz Riviera— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Nizza — der Hauptstadt der Côte d\'Azur, UNESCO-Stadt und zweitgrößtem Luftverkehrstor Frankreichs, mit Veranstaltungen wie AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales und SOLUCOP im Palais des Expositions, am Hafen und in der Allianz Riviera — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Nice — capitale de la Côte d\'Azur, ville UNESCO et deuxième porte aérienne de France, avec des rendez-vous comme AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales et SOLUCOP répartis entre le Palais des Expositions, le port et l\'Allianz Riviera — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Nizza — capitale della Costa Azzurra, città UNESCO e seconda porta aerea di Francia, con appuntamenti come AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales e SOLUCOP distribuiti tra il Palais des Expositions, il porto e l\'Allianz Riviera — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Nice — hoofdstad van de Côte d\'Azur, UNESCO-stad en de tweede luchthaven-toegangspoort van Frankrijk, met evenementen zoals AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales en SOLUCOP verspreid over het Palais des Expositions, de haven en de Allianz Riviera — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在尼斯为展会设计并搭建展台——这是蔚蓝海岸的首府、联合国教科文组织名录城市，也是法国第二大航空门户，AGECOTEL、Nice Boating Tomorrow、IBT Côte d\'Azur、Les Entreprenariales 和 SOLUCOP 等展会分布在 Palais des Expositions、港口和 Allianz Riviera——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 니스에서 전시회 부스를 디자인하고 시공합니다. 이곳은 코트다쥐르의 중심 도시이자 유네스코 등재 도시, 프랑스 제2의 항공 관문으로, AGECOTEL, Nice Boating Tomorrow, IBT Côte d\'Azur, Les Entreprenariales, SOLUCOP 등이 Palais des Expositions, 항구, Allianz Riviera에서 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、ニースで展示会ブースの設計・施工を行います。ここはコート・ダジュールの中心都市であり、ユネスコ登録都市、フランス第2の空の玄関口で、AGECOTEL、Nice Boating Tomorrow、IBT Côte d\'Azur、Les Entreprenariales、SOLUCOPなどがPalais des Expositions、港、Allianz Rivieraで開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  montpellier: {
    ...
    content: {
      ...
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Montpellier — Co-Hauptstadt Okzitaniens und Welthauptstadt der Weinbautechnik und des Bio-Weins, mit Veranstaltungen wie SITEVI, Millésime Bio, SETT, EnerGaïa und SIPRHO im Parc des Expositions sowie dem Antibody Industrial Symposium im Le Corum — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      ...
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Montpellier — co-capitale de l\'Occitanie et capitale mondiale du machinisme vitivinicole et du vin bio, avec des rendez-vous comme le SITEVI, Millésime Bio, le SETT, EnerGaïa et le SIPRHO au Parc des Expositions et l\'Antibody Industrial Symposium au Corum — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Montpellier — co-capitale dell\'Occitania e capitale mondiale delle attrezzature vitivinicole e del vino biologico, con appuntamenti come SITEVI, Millésime Bio, SETT, EnerGaïa e SIPRHO al Parc des Expositions e l\'Antibody Industrial Symposium al Corum — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Montpellier — co-hoofdstad van Occitanië en wereldhoofdstad van wijnbouwtechniek en biologische wijn, met evenementen zoals SITEVI, Millésime Bio, SETT, EnerGaïa en SIPRHO in het Parc des Expositions en het Antibody Industrial Symposium in Le Corum — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在蒙彼利埃为展会设计并搭建展台——这是奥克西塔尼大区的联合首府，也是葡萄种植设备和有机葡萄酒的世界之都，Parc des Expositions 举办 SITEVI、Millésime Bio、SETT、EnerGaïa 和 SIPRHO 等展会，Le Corum 举办 Antibody Industrial Symposium——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      ...
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 몽펠리에에서 전시회 부스를 디자인하고 시공합니다. 이곳은 옥시타니의 공동 중심 도시이자 포도 재배 장비와 유기농 와인의 세계 수도로, Parc des Expositions에서 SITEVI, Millésime Bio, SETT, EnerGaïa, SIPRHO가, Le Corum에서 Antibody Industrial Symposium이 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、モンペリエで展示会ブースの設計・施工を行います。ここはオクシタニー地域圏の共同中心都市であり、ワイン醸造機材とオーガニックワインの世界的な都で、Parc des ExpositionsでSITEVI、Millésime Bio、SETT、EnerGaïa、SIPRHOが、Le CorumでAntibody Industrial Symposiumが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  perpignan: {
    ...
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza la frontera —a un paso de Girona— y diseña y monta stands en Perpiñán, capital de la Cataluña Norte y sede de la Foire Exposition de Perpignan en el Parc des Expositions, controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, con la ventaja de la proximidad al norte de España.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the border —a stone\'s throw from Girona— to design and assemble exhibition stands in Perpignan, capital of Northern Catalonia and home to the Foire Exposition de Perpignan at the Parc des Expositions, controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, with the advantage of proximity to northern Spain.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überschreitet Standarte die Grenze — nur einen Steinwurf von Girona entfernt — und entwirft und montiert Messestände in Perpignan, der Hauptstadt Nordkataloniens und Austragungsort der Foire Exposition de Perpignan im Parc des Expositions, und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, mit dem Vorteil der Nähe zu Nordspanien.' },
      pt: { intro: 'Com 20 anos de experiência a construir arquitetura efémera a partir da nossa oficina própria, a Standarte atravessa a fronteira — a um passo de Girona — e projeta e monta stands em Perpinhã, capital da Catalunha Norte e sede da Foire Exposition de Perpignan no Parc des Expositions, controlando cada fase: design 3D, fabrico, transporte, montagem e validações no recinto.', detail: 'Oferecemos a agências e expositores a tranquilidade de uma montagem sem surpresas e uma excecional atenção aos detalhes, com a vantagem da proximidade ao norte de Espanha.' },
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit la frontière — à deux pas de Gérone — et conçoit et monte des stands à Perpignan, capitale de la Catalogne Nord et siège de la Foire Exposition de Perpignan au Parc des Expositions, en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, avec l\'avantage de la proximité avec le nord de l\'Espagne.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca il confine — a due passi da Girona — e progetta e monta stand a Perpignano, capitale della Catalogna del Nord e sede della Foire Exposition de Perpignan al Parc des Expositions, controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, con il vantaggio della vicinanza al nord della Spagna.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de grens over — op een steenworp van Girona — en ontwerpt en monteert beursstands in Perpignan, hoofdstad van Noord-Catalonië en thuisbasis van de Foire Exposition de Perpignan in het Parc des Expositions, met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, met het voordeel van de nabijheid tot Noord-Spanje.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越边境——距离赫罗纳仅一步之遥——在佩皮尼昂为展会设计并搭建展台，这里是北加泰罗尼亚的中心，Parc des Expositions 举办佩皮尼昂博览会，全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，并具备毗邻西班牙北部的地利。' },
      hi: { intro: 'अपनी ही कार्यशाला से अस्थायी वास्तुकला बनाने के 20 वर्षों के अनुभव के साथ, Standarte सीमा पार करके — गिरोना से बस एक कदम की दूरी पर — पेर्पिञ्यां में स्टैंड डिज़ाइन और स्थापित करता है, जो उत्तरी कैटालोनिया की राजधानी है और जहाँ Parc des Expositions में Foire Exposition de Perpignan आयोजित होती है, हर चरण को नियंत्रित करते हुए: 3D डिज़ाइन, निर्माण, परिवहन, स्थापना और स्थल पर सत्यापन।', detail: 'हम एजेंसियों और प्रदर्शकों को उत्तरी स्पेन से निकटता के लाभ के साथ, बिना किसी आश्चर्य के असेंबली और विवरण पर असाधारण ध्यान की निश्चिंतता प्रदान करते हैं।' },
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 지로나에서 지척인 국경을 넘어 페르피냥에서 전시회 부스를 디자인하고 시공합니다. 이곳은 북카탈루냐의 중심지로, Parc des Expositions에서 Foire Exposition de Perpignan이 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 스페인 북부와 가깝다는 이점과 함께, 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはジローナのすぐ近くにある国境を越え、ペルピニャンで展示会ブースの設計・施工を行います。ここは北カタルーニャの中心都市で、Parc des ExpositionsでペルピニャンのFoire Expositionが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、スペイン北部に近いという利点とともに、想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  gijon: {
