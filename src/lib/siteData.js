...
export const cityData = {
  ...
  cannes: {
    ...
    content: {
      es: { intro: 'Con 20 años de experiencia construyendo arquitectura efímera desde nuestro taller propio, Standarte cruza los Pirineos y diseña y monta stands en Cannes —capital del lujo en la Costa Azul, sede del Cannes Yachting Festival y de MAPIC en el Palais des Festivals— controlando cada fase: diseño 3D, fabricación, transporte, montaje y validaciones en el recinto.', detail: 'Ofrecemos a agencias y expositores la tranquilidad de un montaje sin sorpresas y una atención al detalle excepcional, también al otro lado de la frontera.' },
      en: { intro: 'With 20 years of experience building temporary architecture from our own workshop, Standarte crosses the Pyrenees to design and assemble exhibition stands in Cannes —the French Riviera\'s capital of luxury, home to the Cannes Yachting Festival and MAPIC at the Palais des Festivals— controlling every phase: 3D design, production, transport, assembly and on-site validations.', detail: 'We offer agencies and direct exhibitors the peace of mind of an assembly without surprises and exceptional attention to detail, on the other side of the border too.' },
      de: { intro: 'Mit 20 Jahren Erfahrung im Bau temporärer Architektur aus eigener Werkstatt überquert Standarte die Pyrenäen und entwirft und montiert Messestände in Cannes — der Luxushauptstadt der Côte d\'Azur, Austragungsort des Cannes Yachting Festival und der MAPIC im Palais des Festivals — und kontrolliert jede Phase: 3D-Design, Produktion, Transport, Montage und Abnahmen vor Ort.', detail: 'Wir bieten Agenturen und Direktausstellern die Sicherheit eines reibungslosen Aufbaus und herausragende Detailgenauigkeit, auch jenseits der Grenze.' },
      pt: { intro: 'Com 20 anos de experiência a construir arquitetura efémera a partir da nossa oficina própria, a Standarte atravessa os Pirenéus e projeta e monta stands em Cannes — capital do luxo na Côte d\'Azur, sede do Cannes Yachting Festival e da MAPIC no Palais des Festivals — controlando cada fase: design 3D, fabrico, transporte, montagem e validações no recinto.', detail: 'Oferecemos a agências e expositores a tranquilidade de uma montagem sem surpresas e uma excecional atenção aos detalhes, também do outro lado da fronteira.' },
      fr: { intro: 'Forte de 20 ans d\'expérience dans l\'architecture éphémère réalisée dans son propre atelier, Standarte franchit les Pyrénées et conçoit et monte des stands à Cannes — capitale du luxe sur la Côte d\'Azur, siège du Cannes Yachting Festival et du MAPIC au Palais des Festivals — en maîtrisant chaque phase : conception 3D, fabrication, transport, montage et validations sur place.', detail: 'Nous offrons aux agences et aux exposants la tranquillité d\'un montage sans surprise et une attention exceptionnelle aux détails, de l\'autre côté de la frontière aussi.' },
      it: { intro: 'Con 20 anni di esperienza nella realizzazione di architetture effimere dal nostro laboratorio di proprietà, Standarte varca i Pirenei e progetta e monta stand a Cannes — capitale del lusso sulla Costa Azzurra, sede del Cannes Yachting Festival e di MAPIC al Palais des Festivals — controllando ogni fase: progettazione 3D, produzione, trasporto, montaggio e collaudi in loco.', detail: 'Offriamo ad agenzie ed espositori la tranquillità di un montaggio senza sorprese e un\'eccezionale attenzione ai dettagli, anche dall\'altra parte del confine.' },
      nl: { intro: 'Met 20 jaar ervaring in het bouwen van tijdelijke architectuur vanuit onze eigen werkplaats steekt Standarte de Pyreneeën over en ontwerpt en monteert beursstands in Cannes — de luxehoofdstad van de Côte d\'Azur, thuisbasis van het Cannes Yachting Festival en MAPIC in het Palais des Festivals — met volledige controle over elke fase: 3D-ontwerp, productie, transport, montage en keuringen ter plaatse.', detail: 'Wij bieden agentschappen en exposanten de zekerheid van een montage zonder verrassingen en uitzonderlijke aandacht voor detail, ook aan de andere kant van de grens.' },
      zh: { intro: '凭借20年在自有工厂打造临时建筑的经验，Standarte 跨越比利牛斯山，在戛纳为展会设计并搭建展台——这是蔚蓝海岸的奢华之都，举办戛纳游艇展和 MAPIC（于电影节宫）——全程掌控每个环节：3D设计、制造、运输、安装以及现场验收。', detail: '我们为代理机构和参展商提供无意外的搭建保障，以及对细节的卓越把控，即便在边境的另一侧。' },
      hi: { intro: 'अपनी ही कार्यशाला से अस्थायी वास्तुकला बनाने के 20 वर्षों के अनुभव के साथ, Standarte पिरेनीज़ पार करके कान में स्टैंड डिज़ाइन और स्थापित करता है — यह कोट डी\'अज़ूर की विलासिता की राजधानी है, जहाँ Palais des Festivals में Cannes Yachting Festival और MAPIC आयोजित होते हैं — हर चरण को नियंत्रित करते हुए: 3D डिज़ाइन, निर्माण, परिवहन, स्थापना और स्थल पर सत्यापन।', detail: 'हम एजेंसियों और प्रदर्शकों को सीमा के उस पार भी बिना किसी आश्चर्य के असेंबली और विवरण पर असाधारण ध्यान की निश्चिंतता प्रदान करते हैं।' },
      ko: { intro: '자체 공방에서 임시 건축물을 제작해 온 20년의 경험을 바탕으로, Standarte는 피레네를 넘어 칸에서 전시회 부스를 디자인하고 시공합니다. 이곳은 코트다쥐르의 럭셔리 중심지로, Palais des Festivals에서 칸 요트 페스티벌과 MAPIC이 열리며, 3D 디자인, 제작, 운송, 설치, 현장 검수까지 모든 공정을 관리합니다.', detail: '에이전시와 참가 업체에 국경 건너에서도 예상치 못한 문제가 없는 시공과 탁월한 디테일 관리를 제공합니다.' },
      ja: { intro: '自社工房で仮設建築を手がけてきた20年の経験をもとに、Standarteはピレネーを越え、カンヌで展示会ブースの設計・施工を行います。ここはコート・ダジュールを代表するラグジュアリー都市で、Palais des Festivalsでカンヌ・ヨットフェスティバルやMAPICが開催され、3D設計、製作、輸送、設営、会場での検収まですべての工程を管理します。', detail: '代理店にも出展者にも、国境を越えても想定外のない設営と卓越したディテールへのこだわりをお約束します。' }
    }
  },
  avignon: {
