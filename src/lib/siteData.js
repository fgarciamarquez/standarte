...
export const copy = {
  es: {
    ...
    legalText: {
      privacy: '<p>Standarte utiliza los datos enviados a través del formulario únicamente para responder a solicitudes de información, presupuestos y comunicaciones relacionadas con proyectos de stands.</p><p>No usamos estos datos para finalidades ajenas a la solicitud. Puedes pedir acceso, rectificación o supresión escribiendo a hola@standarte.es.</p>',
  ...
  en: {
    ...
    teamRoles: ['Decorator', 'Administrator', 'Workshop', 'Coordination'],
    contactTitle: 'Contact',
    contactNotice: 'The budgets generated from the data extracted from this form are approximate. The final budget will be established when we have written down all the details of the project after a round of talks.',
    ...
    legalText: {
      privacy: '<p>Standarte uses the data submitted through the form only to answer information requests, quotations and communications related to exhibition stand projects.</p><p>We do not use this data for purposes unrelated to your request. You can ask for access, correction or deletion by writing to hola@standarte.es.</p>',
  ...
  de: {
    ...
    teamRoles: ['Dekorateur', 'Administrator', 'Werkstatt', 'Koordination'],
    contactTitle: 'Kontakt',
    contactNotice: 'Die aus den aus diesem Formular extrahierten Daten generierten Budgets sind ungefähre Angaben. Der endgültige Etat wird festgelegt, wenn wir alle Details des Projekts nach einer Runde Gespräche aufgeschrieben haben.',
  ...
  zh: {
    ...
    teamRoles: ['装饰师', '行政主管', '车间', '协调'],
    contactTitle: '接触',
    contactNotice: '从此表单提取的数据生成的预算仅供参考。在我们在一轮谈话后记录下项目的所有细节后，最终预算将确定。',
    ...
    legalText: {
      privacy: '<p>Standarte 仅使用通过表单提交的数据来回复信息请求、报价请求以及与展台项目相关的沟通。</p><p>我们不会将这些数据用于与请求无关的目的。您可以发送邮件至 hola@standarte.es 申请访问、更正或删除。</p>',
  ...
  hi: {
    ...
    teamRoles: ['सजावटकार', 'प्रशासक', 'कारख़ाना', 'समन्वय'],
    contactTitle: 'संपर्क',
    contactNotice: 'इस फॉर्म से निकाले गए डेटा से उत्पन्न बजट अनुमानित हैं। अंतिम बजट तब स्थापित किया जाएगा जब हम बातचीत के एक दौर के बाद परियोजना के सभी विवरण लिख लेंगे।',
    ...
    legalText: {
      privacy: '<p>Standarte फ़ॉर्म के माध्यम से भेजे गए डेटा का उपयोग केवल जानकारी, अनुमान और प्रदर्शनी स्टैंड परियोजनाओं से जुड़ी बातचीत का उत्तर देने के लिए करता है।</p><p>हम इस डेटा का उपयोग आपकी मांग से अलग उद्देश्यों के लिए नहीं करते। आप hola@standarte.es पर लिखकर पहुंच, सुधार या हटाने का अनुरोध कर सकते हैं।</p>',
  ...
  pt: {
    ...
    contactTitle: 'Contacto',
    contactNotice: 'Os orçamentos gerados a partir dos dados extraídos deste formulário são aproximados. O orçamento final será estabelecido quando tivermos escrito todos os detalhes do projeto após uma rodada de negociações.',
