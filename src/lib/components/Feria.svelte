<script>
  ...
  const PILLAR_CITY = {
    ...
    silleda: 'Silleda', ourense: 'Ourense',
    lleida: 'Lleida', girona: 'Girona', irun: 'Irún', logrono: 'Logroño',
