<script>
  ...
  function saveResult(r) {
    // offer_notified lo devuelve el servidor cuando el guardado cambió la fecha de la
    // oferta y por eso salió un correo al cliente: quien edita tiene que verlo.
    if (r && r.ok) { adminMsg = r.offer_notified ? L.offerNotified : L.saved; return true; }
