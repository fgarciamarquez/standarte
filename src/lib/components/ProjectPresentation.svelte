  ...
  <section class="pz-block">
    ...
    {:else}
      <div class="pz-approve-wrap">
        ...
        <button class="pz-approve" class:pz-approve-offer={discValid && !proposalExpired} type="button" on:click={approve} disabled={approving || demo || proposalExpired}>
