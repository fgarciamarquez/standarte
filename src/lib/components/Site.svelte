<script>
  ...
  const SECTION_REGION = {
    ...
    marsella: 'francia-sur', cannes: 'francia-sur', avignon: 'francia-sur', toulouse: 'francia-sur', perpignan: 'francia-sur', burdeos: 'francia-sur', lyon: 'francia-sur', montpellier: 'francia-sur', niza: 'francia-sur'
  };
  const FAIR_CITY_REGION = {
    ...
    'Marsella': 'francia-sur', 'Cannes': 'francia-sur', 'Aviñón': 'francia-sur', 'Toulouse': 'francia-sur', 'Perpiñán': 'francia-sur', 'Burdeos': 'francia-sur', 'Lyon': 'francia-sur', 'Montpellier': 'francia-sur', 'Niza': 'francia-sur',
  ...
  const COVER_OVERRIDE = { murcia: 'murcia-v2', alicante: 'alicante-v2', islas_canarias: 'islas_canarias-v2', islas_de_madeira: 'islas_de_madeira-v2', burdeos: 'burdeos-v2' };
