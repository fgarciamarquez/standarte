<script>
  ...
  const texts = {
    es: {
      ...
      descPlaceholder: 'Descríbenos cómo quieres tu stand: feria, metros cuadrados',
      sendBtn: 'Enviar',
      sending: 'Enviando...',
      thanksTitle: 'Gracias',
    ...
    en: {
      ...
      descPlaceholder: 'Tell us how you want your stand: trade fair, square metres',
      sendBtn: 'Send',
      sending: 'Sending...',
    ...
    pt: {
      ...
      descPlaceholder: 'Diga-nos como quer o seu stand: feira, metros quadrados',
      sendBtn: 'Enviar',
      sending: 'A enviar...',
    ...
    de: {
      ...
      descPlaceholder: 'Beschreiben Sie, wie Sie Ihren Stand möchten: Messe, Quadratmeter',
      sendBtn: 'Senden',
    ...
    fr: {
      ...
      descPlaceholder: 'Décrivez-nous le stand souhaité : salon, mètres carrés',
      sendBtn: 'Envoyer',
    ...
    it: {
      ...
      descPlaceholder: 'Descrivici come vuoi il tuo stand: fiera, metri quadri',
      sendBtn: 'Invia',
    ...
    nl: {
      ...
      descPlaceholder: 'Beschrijf hoe u uw stand wilt: beurs, vierkante meters',
      sendBtn: 'Verzenden',
      sending: 'Verzenden...',
      thanksTitle: 'Bedankt',
    ...
    zh: {
      ...
      descPlaceholder: '请描述您想要的展台：展会、平方米',
      sendBtn: '发送',
      sending: '正在发送...',
      thanksTitle: '谢谢',
      successMsg: '我很快会与您联系',
    ...
    hi: {
      ...
      descPlaceholder: 'हमें बताएं कि आप अपना स्टैंड कैसा चाहते हैं: मेला, वर्ग मीटर',
      sendBtn: 'भेजें',
    ...
    ko: {
      ...
      descPlaceholder: '원하시는 부스를 설명해 주세요: 전시회, 면적(제곱미터)',
      sendBtn: '보내기',
      sending: '전송 중...',
      thanksTitle: '감사합니다',
    ...
    ja: {
      ...
      descPlaceholder: 'ご希望のブースをお聞かせください：展示会、面積（平方メートル）',
      sendBtn: '送信する',
      sending: '送信中...',
